...
eventColorGroups <- c("Roster", "Time", "Pass",
                      "Pass", "Offense", "DefenseB",
                      "Offense", "DefenseA", "Offense",
                      "DefenseB", "Offense", "DefenseB",
                      "Shot", "DefenseB", "DefenseB",
                      "DefenseC", "Foul", "Foul", 
                      "Offense", "Foul", "Offense", 
                      "Time", "Roster", "Roster", 
                      "Time", "Shot", "Shot",
                      "Time", "DefenseC", "Roster", 
                      "Roster", "Offense", "Foul")
...
ecg <- data.frame(
  ...
  color = c(shUEFA["blueDk"], shUEFA["blueNavy"], shUEFA["ibm_orange"], shUEFA["ibm_yellow"], shUEFA["purple"], shUEFA["ibm_purple"], shUEFA["ibm_pink"], shUEFA["purpleLt"], shUEFA["red"])
...
#adding coords for legend plot
eventTypes <- eventTypes %>% mutate(plot_x = c(1:11, 1:11, 1:11),
                                    plot_y = c(rep(5, 11), rep(3, 11), rep(1, 11)))
